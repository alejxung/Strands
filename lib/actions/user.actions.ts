...
// Almost similar to Strand (search + pagination) and Community (search + pagination)
...
export async function getActivity(userId: string) {
  try {
    ...
    // Collect all the child strand ids (replies) from the 'children' field of each user strand
    const childStrandIds = userStrands.reduce((acc, userStrand) => {
